...
public class GoreaTomatoPlant extends BlockCrops
{
	@SideOnly(Side.CLIENT)
    private Icon[] iconArray; 

	 public GoreaTomatoPlant(int par1)
	    {
	        super(par1);
	 ...
	 public void onNeighborBlockChange (World world, int x, int y, int z,
	     ...
	     if (!canBlockStay(world, x, y, z)) {
	         ...
	         world.setBlockMetadataWithNotify(x, y, z, 0, neighborId);
	     }
	 }*/
	 ...
	 public void fertilize(World par1World, int par2, int par3, int par4)
	    ...
	    {
	    	return GoreaFarming.tomatoSeedsItem.itemID;
	        //return GoreaFarming.getTomatoseedsID();
	    }
	    ...
	    /**
	     * inregistrez texturile 'tomatoplant_stage_X.png'
	     */
	    public void registerIcons(IconRegister par1IconRegister)
	    {
	    	// Cate faze de crestere Icon[X]
	        this.iconArray = new Icon[8];

	        for (int i = 0; i < this.iconArray.length; ++i)
	        {
	            this.iconArray[i] = par1IconRegister.registerIcon("GoreaFarming:tomatoplant" + "_stage_" + i);
	        }
	    }
	}
